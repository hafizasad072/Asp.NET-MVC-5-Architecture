...
namespace Util
{
    public class Mapper
    {
        public TD MapObject<TS,TD>(TS Source)
        {
        ...
        public List<TD> MapList<TS, TD>(List<TS> Source)
        {
            var config = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<TS, TD>();
        ...
        public IQueryable<TD> MapIQueryable<TS, TD>(IQueryable<TS> Source)
        {
            var config = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<TS, TD>();
        ...
        public IEnumerable<TD> MapIEnumerable<TS, TD>(IEnumerable<TS> Source)
        {
            var config = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<TS, TD>();
